...
CREDIT = os.environ.get("CREDIT", "RI$HI")
# MongoDB Configuration
DATABASE_NAME = os.environ.get("DATABASE_NAME", "DevThanos")
DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://rishimeghvanshi111_db_user:kPBdVvqzphnjjO2A
@cluster0.zscjsxh.mongodb.net/")  # Add your own atlas db
